...
_magic_number = 2
_modified_time = 1205061667.9059999
_template_filename=u'C:\\temp\\pylons\\weekdaymasses\\weekdaymasses\\templates/es/base.mako'
_template_uri=u'/es/base.mako'
...
def render_quick_links(context):
    ...
    try:
        ...
        context.write(u'/" class="internal">[Casa]</a>\n    <a href="/')
        # SOURCE LINE 6
        context.write(unicode(c.language))
        context.write(u'/area/gb/postcodes/" class="internal">[Iglesias por codigo postal]</a>\n    <a href="/')
        # SOURCE LINE 7
        context.write(unicode(c.language))
