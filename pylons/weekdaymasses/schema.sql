CREATE TABLE area_areas
(
  area_id INTEGER NOT NULL,
  in_area_id INTEGER NOT NULL
);
CREATE TABLE area_day_church_masses
(
  area_id INTEGER NOT NULL,
...
CREATE TABLE motorway_churches
(
  id INTEGER NOT NULL,
  church_id INTEGER NOT NULL,
...
GROUP BY
  ca.in_area_id,
  day;
CREATE VIEW v_area_sub_day_masses
AS SELECT
...
JOIN areas AS a ON
  a.id = ca.in_area_id;
CREATE VIEW v_church_day_masses
AS SELECT
